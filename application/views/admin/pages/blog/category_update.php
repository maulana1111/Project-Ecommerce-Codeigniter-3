                    ...
                    <div class="col-lg-12">
                        <?php echo form_open() ?>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo $data->category_name ?>" name="category_name" />
                        ...
                        <tbody>
                            <?php foreach($category_product as $row) { ?>
                                <tr>
                                    ...
                                    <td class="center"><a href="" class="btn btn-primary btn-xs" type="button">Delete</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>

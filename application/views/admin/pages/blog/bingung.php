                        ...
                        <?php echo form_open_multipart() ?>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    ...
                                    <?php $i = 1; foreach($category as $row)  { ?>
                                            <?php if($z = $i) { ?>
                                                <option <?php echo $select ?> value="<?php echo $i ?>"><?php echo $row->category_name ?></option>
                                            <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="color" class="form-control">
                                    ...
                                    <?php $b=1; foreach($color as $row) { ?>
                                            <option value="<?php echo $b ?>"><?php echo $row->color_name ?></option>
                                    <?php $b++; } ?>
